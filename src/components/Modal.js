function Modal(props){
    ...
    return(
        <div className="static font-mono">
            ...
            <div className="modal min-w-max bg-transparent">
            <div className="modal-box w-7xl bg-black text-white bg-gradient-to-r from-black via-gray-700 to-green-800">
            <kbd className="kbd kbd-lg text-black text-2xl">{obj.title}</kbd> <br/>
            <kbd className="kbd text-black mt-2 mb-2 text-lg">From: {obj.date_from}</kbd> <br/>
            <kbd className="kbd text-black mb-3 text-lg">To: {obj.date_to}</kbd>
